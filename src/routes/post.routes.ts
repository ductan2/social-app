...
class PostRouter {
   ...
   public routes() {
      ...
      this.router.get("/video/:page",authMiddleware.checkAuthentication,postController.getPostsWithVideos)
      ...
      this.router.post('/video', authMiddleware.checkAuthentication, postController.createPostWithVideo);
