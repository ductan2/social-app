...
```bash
git clone https://github.com/ductan2/social-app
cd social-app
npm install
```
...
- Make sure to uncomment this line `sameSite: 'none'` inside `server.ts` file.
...
## You can find the frontend code [here](https://github.com/ductan2/social-app-ui)
