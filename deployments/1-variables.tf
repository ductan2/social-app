...
variable "vpc_private_subnets" {
  ...
  type        = list(string)
  default     = ["10.0.0.3/24","10.0.0.4/24"]
}
...
variable "main_api_server_domain" {
  ...
  type        = string
  default     = "chatappdt.ddns.net"
}

variable "dev_api_server_domain" {
  description = "Dev API Server Domain"
  type        = string
  default     = "api.dev.chatappdt.ddns.net"
}

variable "ec2_iam_role_name" {
  description = "EC2 IAM Role Name"
  type        = string
  default     = "chatappdt-server-ec2-role"
}

variable "ec2_iam_role_policy_name" {
  description = "EC2 IAM Role Policy Name"
  type        = string
  default     = "chatappdt-server-ec2-role-policy"
}

variable "ec2_instance_profile_name" {
  description = "EC2 Instance Profile Name"
  type        = string
  default     = "chatappdt-server-ec2-instance-profile"
}
...
variable "code_deploy_role_name" {
  ...
  type        = string
  default     = "chatappdt-server-codedeploy-role"
}

variable "prefix" {
  description = "Prefix to be added to AWS resources tags"
  type        = string
  default     = "chatappdt-server"
}
